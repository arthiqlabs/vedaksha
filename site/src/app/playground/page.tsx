...
const DEMO_RESULTS: Record<string, DemoResult> = {
  "2024-03-20": {
    ...
    planets: [
      { name: "Sun", longitude: "336°10′", sign: "Pisces", nakshatra: "Uttara Bhadrapada", pada: 1, retro: false },
      { name: "Moon", longitude: "104°06′", sign: "Cancer", nakshatra: "Pushya", pada: 4, retro: false },
      { name: "Mars", longitude: "303°52′", sign: "Aquarius", nakshatra: "Dhanishta", pada: 4, retro: false },
      { name: "Mercury", longitude: "353°47′", sign: "Pisces", nakshatra: "Revati", pada: 3, retro: false },
      { name: "Jupiter", longitude: "20°46′", sign: "Aries", nakshatra: "Bharani", pada: 3, retro: false },
      { name: "Venus", longitude: "316°26′", sign: "Aquarius", nakshatra: "Shatabhisha", pada: 3, retro: false },
      { name: "Saturn", longitude: "318°04′", sign: "Aquarius", nakshatra: "Shatabhisha", pada: 4, retro: false },
    ],
    houses: [
      { house: 1, longitude: "143°29′", sign: "Leo" },
      { house: 2, longitude: "170°51′", sign: "Virgo" },
      { house: 3, longitude: "201°11′", sign: "Libra" },
      { house: 4, longitude: "232°56′", sign: "Scorpio" },
      { house: 5, longitude: "264°32′", sign: "Sagittarius" },
      { house: 6, longitude: "295°01′", sign: "Capricorn" },
      { house: 7, longitude: "323°29′", sign: "Aquarius" },
      { house: 8, longitude: "350°51′", sign: "Pisces" },
      { house: 9, longitude: "21°11′", sign: "Aries" },
      { house: 10, longitude: "52°56′", sign: "Taurus" },
      { house: 11, longitude: "84°32′", sign: "Gemini" },
      { house: 12, longitude: "115°01′", sign: "Cancer" },
    ],
    dasha: [
  ...
  "1969-07-20": {
    ...
    planets: [
      { name: "Sun", longitude: "94°29′", sign: "Cancer", nakshatra: "Pushya", pada: 1, retro: false },
      { name: "Moon", longitude: "164°27′", sign: "Virgo", nakshatra: "Hasta", pada: 2, retro: false },
      { name: "Mars", longitude: "219°20′", sign: "Scorpio", nakshatra: "Anuradha", pada: 2, retro: false },
      { name: "Mercury", longitude: "92°25′", sign: "Cancer", nakshatra: "Punarvasu", pada: 4, retro: false },
      { name: "Jupiter", longitude: "157°19′", sign: "Virgo", nakshatra: "Uttara Phalguni", pada: 4, retro: false },
      { name: "Venus", longitude: "51°37′", sign: "Taurus", nakshatra: "Rohini", pada: 4, retro: false },
      { name: "Saturn", longitude: "14°40′", sign: "Aries", nakshatra: "Bharani", pada: 1, retro: false },
    ],
    houses: [
      { house: 1, longitude: "206°03′", sign: "Libra" },
      { house: 2, longitude: "235°39′", sign: "Scorpio" },
      { house: 3, longitude: "267°56′", sign: "Sagittarius" },
      { house: 4, longitude: "301°46′", sign: "Aquarius" },
      { house: 5, longitude: "334°02′", sign: "Pisces" },
      { house: 6, longitude: "2°06′", sign: "Aries" },
      { house: 7, longitude: "26°03′", sign: "Aries" },
      { house: 8, longitude: "55°39′", sign: "Taurus" },
      { house: 9, longitude: "87°56′", sign: "Gemini" },
      { house: 10, longitude: "121°46′", sign: "Leo" },
      { house: 11, longitude: "154°02′", sign: "Virgo" },
      { house: 12, longitude: "182°06′", sign: "Libra" },
    ],
    dasha: [
