...
pub static MAIN: LazyLock<Vec<ElpMainTerm>> = LazyLock::new(|| {
    parse_elp_main(include_bytes!("moon_latitude/main.bin"))
        .expect("malformed moon_latitude/main.bin")
});

pub static PERT_0: LazyLock<Vec<ElpPertTerm>> = LazyLock::new(|| {
    parse_elp_pert(include_bytes!("moon_latitude/pert_0.bin"))
        .expect("malformed moon_latitude/pert_0.bin")
});

pub static PERT_1: LazyLock<Vec<ElpPertTerm>> = LazyLock::new(|| {
    parse_elp_pert(include_bytes!("moon_latitude/pert_1.bin"))
        .expect("malformed moon_latitude/pert_1.bin")
});

pub static PERT_2: LazyLock<Vec<ElpPertTerm>> = LazyLock::new(|| {
    parse_elp_pert(include_bytes!("moon_latitude/pert_2.bin"))
        .expect("malformed moon_latitude/pert_2.bin")
});

pub static PERT_3: LazyLock<Vec<ElpPertTerm>> = LazyLock::new(|| {
    parse_elp_pert(include_bytes!("moon_latitude/pert_3.bin"))
        .expect("malformed moon_latitude/pert_3.bin")
});
