...
pub static MAIN: LazyLock<Vec<ElpMainTerm>> = LazyLock::new(|| {
    parse_elp_main(include_bytes!("moon_distance/main.bin"))
        .expect("malformed moon_distance/main.bin")
});

pub static PERT_0: LazyLock<Vec<ElpPertTerm>> = LazyLock::new(|| {
    parse_elp_pert(include_bytes!("moon_distance/pert_0.bin"))
        .expect("malformed moon_distance/pert_0.bin")
});

pub static PERT_1: LazyLock<Vec<ElpPertTerm>> = LazyLock::new(|| {
    parse_elp_pert(include_bytes!("moon_distance/pert_1.bin"))
        .expect("malformed moon_distance/pert_1.bin")
});

pub static PERT_2: LazyLock<Vec<ElpPertTerm>> = LazyLock::new(|| {
    parse_elp_pert(include_bytes!("moon_distance/pert_2.bin"))
        .expect("malformed moon_distance/pert_2.bin")
});

pub static PERT_3: LazyLock<Vec<ElpPertTerm>> = LazyLock::new(|| {
    parse_elp_pert(include_bytes!("moon_distance/pert_3.bin"))
        .expect("malformed moon_distance/pert_3.bin")
});
