...
from JPL DE440s/DE441 SPK numerical kernels, and derives from them the constructs used in
...
implementation: no source code, header, or documentation of the GNU Affero General Public
Licensed (AGPL) Swiss Ephemeris library, on which prior Vedic astrology software has commonly
relied, was consulted at any point in the engine's construction. This clean-room provenance is
not merely asserted: it is documented per data source, with fetch dates and content hashes, in a
public provenance ledger, and specific re-derivations carry dated, auditable clean-room evidence
trails. Vedaksha is released under the Business Source License 1.1 (converting to Apache License
...
distributed by a national agency, such as the JPL DE440s/DE441 SPK ephemerides --- and no source
code, header file, or documentation belonging to an existing proprietary or copyleft-licensed
ephemeris implementation was consulted at any stage. This claim is deliberately made verifiable
