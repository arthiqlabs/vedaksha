...
relied. (Two early sidereal-offset constants were briefly cross-referenced against a published
Swiss Ephemeris header solely to identify a numeric value; both were independently re-derived
...
distributed by a national agency, such as the JPL DE440s/DE441 SPK ephemerides --- and the
...
The project's history is more instructive than a blanket denial: two early ayanamsha
...
copied, and the numeric constants themselves are uncopyrightable facts --- and both were
