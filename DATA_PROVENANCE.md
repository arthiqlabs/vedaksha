...
### Fix 11 — Chara Dasha's even-lagna direction was a disclosed simplification, now completed (superseded by Fix 12 below)
...
**Confidence grade withdrawn by Fix 12 (2026-08-31):** the "high confidence" grade above on
sutras 25-26 as a *direction* rule does not survive Fix 12's research — those sutras are now
understood to govern sign-to-lord counting instead, and "corroborated by essentially every
secondary source found" turned out to describe a rule this module no longer applies to direction
at all. Left in place as a record of what was believed and why, not as still-current guidance;
see Fix 12 for the correction.

## Accuracy fixes — 2026-08-31

### Fix 12 — Chara Dasha direction is tested at the 9th sign from lagna, not the lagna itself (supersedes Fix 11 above)
...
arithmetically to nine, not five. This decoding is not asserted on trust here: the cipher and the
eight-word check that establishes it are recorded in full at
[`docs/audit/2026-08-31-chara-dasha-panchame-cipher.md`](docs/audit/2026-08-31-chara-dasha-panchame-cipher.md)
(high confidence — a verifiable arithmetic fact, checkable by anyone from that record). Under that
decoding, the sutra is read as: take the 9th sign from the lagna, and test *that* sign — not the
lagna — for direction.
Fix 11 (above) cited Adhyaya 1 Pada 1, sutras 25-27, for direction, testing the lagna sign directly
